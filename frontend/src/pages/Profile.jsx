    ...
    <div className="w-full min-h-screen bg-[#253745] flex flex-col justify-center items-center gap-5 font-sans">
      ...
      >
        ...
        <div className="w-full flex flex-col gap-2">
          <label className="text-slate-300 text-sm ml-2 font-medium">
            Display Name
          </label>
          <input
        ...
        {/* Submit Button */}
        <button
          className={`w-full max-w-50 h-12 font-bold shadow-xl cursor-pointer rounded-xl transition-all mt-4 mb-4
            ${
              saving
